...
export default function SuccessPage() {
  ...
  const colorMap: Record<
    string,
    { bg: string; border: string; num: string; title: string; text: string; tag: string }
  > = {
    red: {
      bg: 'bg-red-50',
      border: 'border-red-100',
      num: 'border-red-400 text-red-600',
      title: 'text-red-900',
      text: 'text-red-800',
    ...
    orange: {
      ...
      num: 'border-orange-400 text-orange-600',
    ...
    slate: {
      ...
      num: 'border-slate-400 text-slate-600',
      ...
      <div className="bg-white shadow-sm overflow-hidden sm:rounded-lg border">
        ...
        <div className="px-4 py-5 sm:p-6 space-y-8">
          <section>
            ...
            <p className="mt-4 text-sm text-gray-700 italic border-l-4 pl-3 py-1 bg-gray-50">
              "{caseData.summary}"
            </p>
          </section>
  ...
  These steps are selected based on the scam type, platform, transfer method, and evidence found in your report.
</p>
                ...
                return (
                  ...
                  >
                    <div className="flex-shrink-0 mt-0.5">
                      <div
                        className={`h-5 w-5 rounded-full border-2 flex items-center justify-center text-xs font-bold transition-all duration-200 ${
                          isDone
                    ...
                    <div className="ml-3">
                      <p
                        className={`text-sm font-bold ${
                          isDone ? 'text-slate-400 line-through' : colors.title
                        }`}
                      >
                        {step.title}{' '}
                        <span
                          className={`ml-2 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-medium uppercase ${
        ...
        <div className="px-4 py-4 sm:px-6 bg-gray-50 border-t flex justify-between">
          ...
          <div className="space-x-4">
            <span className="text-xs text-gray-500 italic">
              Workflow: {caseData.workflowStatus}
            </span>
          </div>
        </div>
      </div>
